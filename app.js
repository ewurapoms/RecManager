"use strict";
// const poms = document.querySelector("#roll-no");
// submit btn
...
const submitBtn = document
  ...
  .addEventListener("click", function (e) {
    ...
    if (
      ...
      } else if (inputData.storage === "SessionStorage") {
      ...
      alert("Please fill all form fields properly");
    }
...
editBtn.forEach((allEditBtn) => {
  allEditBtn.addEventListener("click", function (e) {
    ...
    } else if (typeEdit === "SessionStorage") {
...
deleteBtn.forEach((l) => {
  l.addEventListener("click", function (e) {
    ...
    const poms = sessionStorage.getItem("student");
    let secData = poms && JSON.parse(poms);
